...
public class GlobalHandlerException {
    ...
    @ExceptionHandler({UserNotExistsException.class, TransferNotExistsException.class, AccountNotExistsException.class})
    ...
    public ResponseEntity<?> handlerHttpMessageNotReadable(HttpMessageNotReadableException ex){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Formato Json no Compatible. \n" + ex.getMessage());
    }
}
